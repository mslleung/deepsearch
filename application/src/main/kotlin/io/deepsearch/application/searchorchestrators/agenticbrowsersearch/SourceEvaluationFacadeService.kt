...
/**
 * Facade service for evaluating sources (PDF, Markdown) for relevance to a query.
 * HTML pages are handled by the agentic VLM navigation agent and bypass evaluation.
 */

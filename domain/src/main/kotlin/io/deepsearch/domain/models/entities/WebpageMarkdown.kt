...
data class WebpageMarkdown(
    ...
    /**
     * Serialized PageContentMap JSON cataloging interactive elements and section headings.
     * Populated by the WebpageIndexingService during visual-order indexing.
     * Used by the AgenticWebpageSearchService as hints for in-page navigation.
     */
    val contentMapJson: String? = null,

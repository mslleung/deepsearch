...
interface IOcrImageTextExtractionService {
     ...
     */
    suspend fun extractText(imageBytes: ByteArray, mimeType: ImageMimeType): String
}
...
class OcrImageTextExtractionService(
    ...
    override suspend fun extractText(imageBytes: ByteArray, mimeType: ImageMimeType): String {
